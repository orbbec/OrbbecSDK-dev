...
#define CV__TRACE_DEFINE_LOCATION_(loc_id, name, flags)                                                                                                        \
    ...
    static const CV_TRACE_NS::details::Region::LocationStaticStorage CV__TRACE_LOCATION_VARNAME(loc_id) = { &(CV__TRACE_LOCATION_EXTRA_VARNAME(loc_id)), name, \
...
#define CV__TRACE_DEFINE_ARG_(arg_id, name, flags)                                             \
    ...
    static const CV_TRACE_NS::details::TraceArg       CV__TRACE_ARG_VARNAME(arg_id)       = { &(CV__TRACE_ARG_EXTRA_VARNAME(arg_id)), name, flags };
