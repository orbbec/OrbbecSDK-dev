...
template <typename Impl, typename... Ins, typename... Outs> struct PlaidMLCallHelper<Impl, std::tuple<Ins...>, std::tuple<Outs...>> {
    template <int... IIs, int... OIs> static void call_impl(GPlaidMLContext &ctx, detail::Seq<IIs...>, detail::Seq<OIs...>) {
...
class GPlaidMLKernelImpl : public cv::detail::PlaidMLCallHelper<Impl, typename K::InArgs, typename K::OutArgs>, public cv::detail::KernelTag {
