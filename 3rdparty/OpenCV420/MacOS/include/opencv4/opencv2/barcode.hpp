...
enum BarcodeType { NONE, EAN_8, EAN_13, UPC_A, UPC_E, UPC_EAN_EXTENSION };
...
public:
     ...
     */
    CV_WRAP bool detectAndDecode(InputArray img, CV_OUT std::vector<std::string> &decoded_info, CV_OUT std::vector<BarcodeType> &decoded_type,
