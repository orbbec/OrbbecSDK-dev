...
private:
    Device(Ptr device_ptr, const std::string &device_name, AccelType device_type);
...
GAPI_EXPORTS Device  create_dx11_device(Device::Ptr device_ptr, const std::string &device_name);
GAPI_EXPORTS Context create_dx11_context(Context::Ptr ctx_ptr);

GAPI_EXPORTS Device  create_vaapi_device(Device::Ptr device_ptr, const std::string &device_name);
