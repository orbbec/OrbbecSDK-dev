...
#define CV_LOG_WITH_TAG(tag, msgLevel, ...)                                                                                                            \
    for(;;) {                                                                                                                                          \
        ...
        cv::utils::logging::internal::writeLogMessageEx(cv_temp_msglevel, (cv_temp_logtagptr ? cv_temp_logtagptr->name : nullptr), __FILE__, __LINE__, \
                                                        CV_Func, cv_temp_logstream.str().c_str());                                                     \
        break;                                                                                                                                         \
    }
