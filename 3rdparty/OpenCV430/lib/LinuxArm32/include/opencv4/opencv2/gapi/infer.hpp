...
struct KernelTypeMedium<K, std::function<std::tuple<R...>(Args...)>> : public GKernelTypeM<K, std::function<std::tuple<R...>(Args...)>> {};

template <class K, typename R, typename... Args> struct KernelTypeMedium<K, std::function<R(Args...)>> : public GKernelType<K, std::function<R(Args...)>> {};
...
template <typename Net> struct GInfer final : public GInferBase, public detail::KernelTypeMedium<GInfer<Net>, typename Net::API> {
...
template <typename Net> struct GInferList final : public GInferListBase, public detail::KernelTypeMedium<GInferList<Net>, typename Net::APIList> {
