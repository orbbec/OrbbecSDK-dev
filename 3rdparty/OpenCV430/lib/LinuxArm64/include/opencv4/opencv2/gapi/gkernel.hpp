...
protected:
    ...
    template <typename KImpl> typename std::enable_if<(std::is_base_of<detail::KernelTag, KImpl>::value), void>::type includeHelper() {
    ...
    template <typename TImpl> typename std::enable_if<(std::is_base_of<detail::TransformTag, TImpl>::value), void>::type includeHelper() {
...
public:
    ...
    template <typename KImpl> bool includes() const {
        static_assert(std::is_base_of<detail::KernelTag, KImpl>::value, "includes() can be applied to kernels only");
