...
inline v_int16x8 v_mul_hi(const v_int16x8 &a, const v_int16x8 &b) {
    ...
    return v_int16x8(msa_packr_s32(msa_mulq_s32(msa_paddlq_s16(a_lo), msa_paddlq_s16(b_lo)), msa_mulq_s32(msa_paddlq_s16(a_hi), msa_paddlq_s16(b_hi)), 16));
}
...
inline v_uint16x8 v_mul_hi(const v_uint16x8 &a, const v_uint16x8 &b) {
    ...
    return v_uint16x8(msa_packr_u32(msa_mulq_u32(msa_paddlq_u16(a_lo), msa_paddlq_u16(b_lo)), msa_mulq_u32(msa_paddlq_u16(a_hi), msa_paddlq_u16(b_hi)), 16));
}
...
inline v_float32x4 v_reduce_sum4(const v_float32x4 &a, const v_float32x4 &b, const v_float32x4 &c, const v_float32x4 &d) {
    v4f32 u0 = msa_addq_f32(
        MSA_TPV_REINTERPRET(v4f32, msa_ilvevq_s32(MSA_TPV_REINTERPRET(v4i32, b.val), MSA_TPV_REINTERPRET(v4i32, a.val))),
    ...
    v4f32 u1 = msa_addq_f32(
        MSA_TPV_REINTERPRET(v4f32, msa_ilvevq_s32(MSA_TPV_REINTERPRET(v4i32, d.val), MSA_TPV_REINTERPRET(v4i32, c.val))),
...
#define OPENCV_HAL_IMPL_MSA_SELECT(_Tpvec, _Tpv, _Tpvu)                                                                                      \
    inline _Tpvec v_select(const _Tpvec &mask, const _Tpvec &a, const _Tpvec &b) {                                                           \
        return _Tpvec(MSA_TPV_REINTERPRET(                                                                                                   \
            _Tpv, msa_bslq_u8(MSA_TPV_REINTERPRET(_Tpvu, mask.val), MSA_TPV_REINTERPRET(_Tpvu, b.val), MSA_TPV_REINTERPRET(_Tpvu, a.val)))); \
    }
...
OPENCV_HAL_IMPL_MSA_TRANSPOSE4x4(v_uint32x4, v4u32, v4i32, s32) OPENCV_HAL_IMPL_MSA_TRANSPOSE4x4(v_int32x4, v4i32, v4i32, s32)
...
#define OPENCV_HAL_IMPL_MSA_INTERLEAVED(_Tpvec, _Tp, suffix)                                                                                                  \
    ...
    inline void v_store_interleave(_Tp *ptr, const v_##_Tpvec &a, const v_##_Tpvec &b, const v_##_Tpvec &c, const v_##_Tpvec &d,                              \
        ...
        OPENCV_HAL_IMPL_MSA_INTERLEAVED(uint8x16, uchar, u8) OPENCV_HAL_IMPL_MSA_INTERLEAVED(int8x16, schar, s8)
            OPENCV_HAL_IMPL_MSA_INTERLEAVED(uint16x8, ushort, u16) OPENCV_HAL_IMPL_MSA_INTERLEAVED(int16x8, short, s16)
                OPENCV_HAL_IMPL_MSA_INTERLEAVED(uint32x4, unsigned, u32) OPENCV_HAL_IMPL_MSA_INTERLEAVED(int32x4, int, s32)
                    OPENCV_HAL_IMPL_MSA_INTERLEAVED(float32x4, float, f32) OPENCV_HAL_IMPL_MSA_INTERLEAVED(uint64x2, uint64, u64)
                        OPENCV_HAL_IMPL_MSA_INTERLEAVED(int64x2, int64, s64) OPENCV_HAL_IMPL_MSA_INTERLEAVED(float64x2, double, f64)
...
inline v_uint32x4 v_lut(const unsigned *tab, const v_int32x4 &idxvec) {
    unsigned CV_DECL_ALIGNED(32) elems[4] = { tab[msa_getq_lane_s32(idxvec.val, 0)], tab[msa_getq_lane_s32(idxvec.val, 1)],
