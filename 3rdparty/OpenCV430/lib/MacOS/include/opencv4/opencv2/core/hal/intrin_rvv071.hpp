...
#define OPENCV_HAL_IMPL_RISCVV_INIT_SET(__Tp, _Tp, suffix, len, num) \
    inline v_##_Tp##x##num v_setzero_##suffix() {                    \
        return v_##_Tp##x##num((v##_Tp##m1_t){ 0 });                 \
    }                                                                \
...
inline v_float32x4 v_setzero_f32() {
    return v_float32x4((vfloat32m1_t){ 0 });
}
inline v_float32x4 v_setall_f32(float v) {
    return v_float32x4(vfmv_v_f_f32m1(v, 4));
}

inline v_float64x2 v_setzero_f64() {
    return v_float64x2(vfmv_v_f_f64m1(0, 2));
}
...
inline void v_mul_expand(const v_int32x4 &a, const v_int32x4 &b, v_int64x2 &c, v_int64x2 &d) {
...
#define OPENCV_HAL_IMPL_RISCVV_TRANSPOSE4x4(_Tp, _T)                                                                                                       \
    inline void v_transpose4x4(const v_##_Tp##32x4 & a0, const v_##_Tp##32x4 & a1, const v_##_Tp##32x4 & a2, const v_##_Tp##32x4 & a3, v_##_Tp##32x4 & b0, \
...
OPENCV_HAL_IMPL_RISCVV_TRANSPOSE4x4(uint, u32) OPENCV_HAL_IMPL_RISCVV_TRANSPOSE4x4(int, i32) OPENCV_HAL_IMPL_RISCVV_TRANSPOSE4x4(float, f32)
...
#define OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(suffix, _T, num, intrin)           \
    ...
    OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(uint8, u8, 16, srl) OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(uint16, u16, 8, srl)
        OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(uint32, u32, 4, srl) OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(uint64, u64, 2, srl)
            OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(int8, i8, 16, sra) OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(int16, i16, 8, sra)
                OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(int32, i32, 4, sra) OPENCV_HAL_IMPL_RISCVV_SHIFT_OP(int64, i64, 2, sra)
...
#define OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(_Tpvec, suffix, _T, num, num2, vmv, len)          \
    ...
    template <> inline _Tpvec v_rotate_left<0>(const _Tpvec &a, const _Tpvec &b) {         \
        ...
        return a;                                                                          \
                    ...
                    OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_uint8x16, vuint8, u8, 16, 32, vmv_v_x, b8) OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_int8x16, vint8, i8, 16, 32,
                                                                                                                                   vmv_v_x, b8)
                        OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_uint16x8, vuint16, u16, 8, 16, vmv_v_x, b16) OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_int16x8, vint16, i16,
                                                                                                                                         8, 16, vmv_v_x, b16)
                            OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_uint32x4, vuint32, u32, 4, 8, vmv_v_x,
                                                             b32) OPENCV_HAL_IMPL_RISCVV_ROTATE_OP(v_int32x4, vint32, i32, 4, 8, vmv_v_x, b32)
                                                                        ...
                                                                        OPENCV_HAL_IMPL_RISCVV_LOADSTORE_OP(v_uint64x2, unsigned long, vuint64m1, u64m1, 1, 2)
                                                                            OPENCV_HAL_IMPL_RISCVV_LOADSTORE_OP(v_int64x2, long, vint64m1, i64m1, 1, 2)
                                                                                OPENCV_HAL_IMPL_RISCVV_LOADSTORE_OP(v_float32x4, float, vfloat32m1, f32m1, 2, 4)
                                                                                    OPENCV_HAL_IMPL_RISCVV_LOADSTORE_OP(v_float64x2, double, vfloat64m1, f64m1,
                                                                                                                        1, 2)
...
inline v_int16x8 v_lut_quads(const short *tab, const int *idx) {
    short CV_DECL_ALIGNED(32)
        elems[8] = { tab[idx[0]], tab[idx[0] + 1], tab[idx[0] + 2], tab[idx[0] + 3], tab[idx[1]], tab[idx[1] + 1], tab[idx[1] + 2], tab[idx[1] + 3] };
    return v_int16x8(vle_v_i16m1(elems, 8));
}
...
inline v_int32x4 v_lut_pairs(const int *tab, const int *idx) {
    int CV_DECL_ALIGNED(32) elems[4] = { tab[idx[0]], tab[idx[0] + 1], tab[idx[1]], tab[idx[1] + 1] };
    return v_int32x4(vle_v_i32m1(elems, 4));
}
...
inline v_float32x4 v_lut_pairs(const float *tab, const int *idx) {
    float CV_DECL_ALIGNED(32) elems[4] = { tab[idx[0]], tab[idx[0] + 1], tab[idx[1]], tab[idx[1] + 1] };
    return v_float32x4(vle_v_f32m1(elems, 4));
}
...
inline v_int32x4 v_lut(const int *tab, const v_int32x4 &idxvec) {
    int CV_DECL_ALIGNED(32) elems[4] = { tab[idxvec.val[0]], tab[idxvec.val[1]], tab[idxvec.val[2]], tab[idxvec.val[3]] };
    return v_int32x4(vle_v_i32m1(elems, 4));
}

inline v_uint32x4 v_lut(const unsigned *tab, const v_int32x4 &idxvec) {
    unsigned CV_DECL_ALIGNED(32) elems[4] = { tab[idxvec.val[0]], tab[idxvec.val[1]], tab[idxvec.val[2]], tab[idxvec.val[3]] };
    return v_uint32x4(vle_v_u32m1(elems, 4));
}

inline v_float32x4 v_lut(const float *tab, const v_int32x4 &idxvec) {
    float CV_DECL_ALIGNED(32) elems[4] = { tab[idxvec.val[0]], tab[idxvec.val[1]], tab[idxvec.val[2]], tab[idxvec.val[3]] };
    return v_float32x4(vle_v_f32m1(elems, 4));
}
...
#define OPENCV_HAL_IMPL_RISCVV_PACKS(_Tp, _Tp2, _T2, num2, _T1, num, intrin, shr, _Type)                          \
    ...
    template <int n> inline v_##_Tp##x##num v_rshr_pack(const v_##_Tp2##x##num2 &a, const v_##_Tp2##x##num2 &b) { \
        v##_Tp2##m2_t tmp = vundefined_##_T2##m2();                                                               \
        tmp               = vset_##_T2##m2(tmp, 0, a.val);                                                        \
        tmp               = vset_##_T2##m2(tmp, 1, b.val);                                                        \
    ...
    template <int n> inline void v_rshr_pack_store(_Type *ptr, const v_##_Tp2##x##num2 &a) {                      \
        v##_Tp2##m2_t tmp = vundefined_##_T2##m2();                                                               \
        tmp               = vset_##_T2##m2(tmp, 0, a.val);                                                        \
        tmp               = vset_##_T2##m2(tmp, 1, vmv_v_x_##_T2##m1(0, num2));                                   \
...
#define OPENCV_HAL_IMPL_RISCVV_PACK_U(tp1, num1, tp2, num2, _Tp)                                                             \
    ...
    template <int n> inline v_uint##tp1##x##num1 v_rshr_pack_u(const v_int##tp2##x##num2 &a, const v_int##tp2##x##num2 &b) { \
        vint##tp2##m2_t tmp = vundefined_##i##tp2##m2();                                                                     \
        tmp                 = vset_##i##tp2##m2(tmp, 0, a.val);                                                              \
        tmp                 = vset_##i##tp2##m2(tmp, 1, b.val);                                                              \
        vint##tp2##m2_t val = vmax_vx_i##tp2##m2(tmp, 0, num1);                                                              \
    ...
    template <int n> inline void v_rshr_pack_u_store(_Tp *ptr, const v_int##tp2##x##num2 &a) {                               \
        vint##tp2##m2_t tmp   = vundefined_##i##tp2##m2();                                                                   \
        tmp                   = vset_##i##tp2##m2(tmp, 0, a.val);                                                            \
...
inline v_uint32x4 v_popcount(const v_uint32x4 &a) {
    vuint8m2_t tmp   = vundefined_u8m2();
    tmp              = vset_u8m2(tmp, 0, vcnt_u8((vuint8m1_t)a.val));
    vuint64m2_t mask = (vuint64m2_t){ 0xFFFFFFFF0C080400, 0xFFFFFFFF0D090501, 0xFFFFFFFF0E0A0602, 0xFFFFFFFF0F0B0703 };
    tmp              = vrgather_vv_u8m2(tmp, (vuint8m2_t)mask, 32);
...
inline v_uint64x2 v_popcount(const v_uint64x2 &a) {
    vuint8m2_t tmp   = vundefined_u8m2();
    tmp              = vset_u8m2(tmp, 0, vcnt_u8((vuint8m1_t)a.val));
    vuint64m2_t mask = (vuint64m2_t){ 0x0706050403020100, 0x0000000000000000, 0x0F0E0D0C0B0A0908, 0x0000000000000000 };
    tmp              = vrgather_vv_u8m2(tmp, (vuint8m2_t)mask, 32);
...
#define VITL_16                                                                        \
    (vuint64m2_t) {                                                                    \
        0x1303120211011000, 0x1707160615051404, 0x1B0B1A0A19091808, 0x1F0F1E0E1D0D1C0C \
    }
#define VITL_8                                                                         \
    (vuint64m2_t) {                                                                    \
        0x0009000100080000, 0x000B0003000A0002, 0x000D0005000C0004, 0x000F0007000E0006 \
    }
#define VITL_4                                                                         \
    (vuint64m2_t) {                                                                    \
        0x0000000400000000, 0x0000000500000001, 0x0000000600000002, 0x0000000700000003 \
    }
#define VITL_2      \
    (vuint64m2_t) { \
        0, 2, 1, 3  \
...
#define OPENCV_HAL_IMPL_RISCVV_LOAD_DEINTERLEAVED(intrin, _Tpvec, num, _Tp, _T)                                                                   \
    ...
    inline void v_load_deinterleave(const _Tp *ptr, v_##_Tpvec##x##num &a, v_##_Tpvec##x##num &b, v_##_Tpvec##x##num &c, v_##_Tpvec##x##num &d) { \
...
#define OPENCV_HAL_IMPL_RISCVV_STORE_INTERLEAVED(intrin, _Tpvec, num, _Tp, _T)                                                                           \
    inline void v_store_interleave(_Tp *ptr, const v_##_Tpvec##x##num &a, const v_##_Tpvec##x##num &b, hal::StoreMode /*mode*/ = hal::STORE_UNALIGNED) { \
    ...
    inline void v_store_interleave(_Tp *ptr, const v_##_Tpvec##x##num &a, const v_##_Tpvec##x##num &b, const v_##_Tpvec##x##num &c,                      \
    ...
    inline void v_store_interleave(_Tp *ptr, const v_##_Tpvec##x##num &a, const v_##_Tpvec##x##num &b, const v_##_Tpvec##x##num &c,                      \
                                   const v_##_Tpvec##x##num &d, hal::StoreMode /*mode*/ = hal::STORE_UNALIGNED) {                                        \
