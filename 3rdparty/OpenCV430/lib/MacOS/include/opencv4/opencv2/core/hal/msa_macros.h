...
/* qpack */
#define msa_qpack_s16(__a, __b) (__builtin_msa_pckev_b((v16i8)__builtin_msa_sat_s_h((v8i16)(__b), 7), (v16i8)__builtin_msa_sat_s_h((v8i16)(__a), 7)))
#define msa_qpack_s32(__a, __b) (__builtin_msa_pckev_h((v8i16)__builtin_msa_sat_s_w((v4i32)(__b), 15), (v8i16)__builtin_msa_sat_s_w((v4i32)(__a), 15)))
#define msa_qpack_s64(__a, __b) (__builtin_msa_pckev_w((v4i32)__builtin_msa_sat_s_d((v2i64)(__b), 31), (v4i32)__builtin_msa_sat_s_d((v2i64)(__a), 31)))
#define msa_qpack_u16(__a, __b) ((v16u8)__builtin_msa_pckev_b((v16i8)__builtin_msa_sat_u_h((v8u16)(__b), 7), (v16i8)__builtin_msa_sat_u_h((v8u16)(__a), 7)))
#define msa_qpack_u32(__a, __b) ((v8u16)__builtin_msa_pckev_h((v8i16)__builtin_msa_sat_u_w((v4u32)(__b), 15), (v8i16)__builtin_msa_sat_u_w((v4u32)(__a), 15)))
#define msa_qpack_u64(__a, __b) ((v4u32)__builtin_msa_pckev_w((v4i32)__builtin_msa_sat_u_d((v2u64)(__b), 31), (v4i32)__builtin_msa_sat_u_d((v2u64)(__a), 31)))
...
#else
#define __COMBINE_64_64(__TYPE, a, b) ((__TYPE)((v4u32){ ((v2u32)(a))[0], ((v2u32)(a))[1], ((v2u32)(b))[0], ((v2u32)(b))[1] }))
#endif
...
#define V8U8_2_V8U16(x) \
    { (uint16_t) x[0], (uint16_t)x[1], (uint16_t)x[2], (uint16_t)x[3], (uint16_t)x[4], (uint16_t)x[5], (uint16_t)x[6], (uint16_t)x[7] }
#define V8U8_2_V8I16(x) \
    { (int16_t) x[0], (int16_t)x[1], (int16_t)x[2], (int16_t)x[3], (int16_t)x[4], (int16_t)x[5], (int16_t)x[6], (int16_t)x[7] }
...
/* mlaq: r = a + b * c; */
__extension__ extern __inline v4i32 __attribute__((__always_inline__, __gnu_inline__, __artificial__)) msa_mlaq_s32(v4i32 __a, v4i32 __b, v4i32 __c) {
...
__extension__ extern __inline v2i64 __attribute__((__always_inline__, __gnu_inline__, __artificial__)) msa_mlaq_s64(v2i64 __a, v2i64 __b, v2i64 __c) {
...
__extension__ extern __inline v4f32 __attribute__((__always_inline__, __gnu_inline__, __artificial__)) msa_mlaq_f32(v4f32 __a, v4f32 __b, v4f32 __c) {
...
__extension__ extern __inline v2f64 __attribute__((__always_inline__, __gnu_inline__, __artificial__)) msa_mlaq_f64(v2f64 __a, v2f64 __b, v2f64 __c) {
...
__extension__ extern __inline v8i16 __attribute__((__always_inline__, __gnu_inline__, __artificial__)) msa_qdmulhq_n_s16(v8i16 a, int16_t b) {
    v8i16 a_lo, a_hi;
