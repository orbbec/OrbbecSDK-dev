...
protected:
     ...
     */
    void filter_top_n(std::vector<std::vector<double>> *probs, std::vector<std::vector<double>> *boxes, std::vector<std::vector<double>> &top_n_boxes,
                      std::vector<size_t> &top_n_idxs, std::vector<double> &top_n_probs);
    ...
    static inline bool comparator(std::pair<double, size_t> l1, std::pair<double, size_t> l2) {
