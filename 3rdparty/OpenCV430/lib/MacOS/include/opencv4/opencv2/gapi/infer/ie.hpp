...
public:
    ...
    */
    Params<Net> &cfgInputLayers(const typename PortCfg<Net>::In &layer_names) {
        ...
        std::copy(layer_names.begin(), layer_names.end(), std::back_inserter(desc.input_names));
        return *this;
    }
    ...
    */
    Params<Net> &cfgOutputLayers(const typename PortCfg<Net>::Out &layer_names) {
        ...
        std::copy(layer_names.begin(), layer_names.end(), std::back_inserter(desc.output_names));
        return *this;
    }
    ...
    */
    ...
    1. Asynchronous (using StartAsync:
    https://docs.openvino.ai/latest/classInferenceEngine_1_1InferRequest.html#doxid-class-inference-engine-1-1-infer-request-1a405293e8423d82a5b45f642a3bef0d24)
    2. Synchronous (using Infer:
    https://docs.openvino.ai/latest/classInferenceEngine_1_1InferRequest.html#doxid-class-inference-engine-1-1-infer-request-1a3391ce30894abde730523e9ca9371ce8)
 ...
 * @see struct Generic
 */
template <> class Params<cv::gapi::Generic> {
public:
    /** @brief Class constructor.
    ...
    */
    Params(const std::string &tag, const std::string &model, const std::string &weights, const std::string &device)
        : desc{ model, weights, device, {}, {}, {}, 0u, 0u, detail::ParamDesc::Kind::Load, true, {}, {}, {}, 1u, {}, {}, {}, {}, InferMode::Async, {} },
          m_tag(tag){};
    ...
    */
    Params(const std::string &tag, const std::string &model, const std::string &device)
        : desc{ model, {}, device, {}, {}, {}, 0u, 0u, detail::ParamDesc::Kind::Import, true, {}, {}, {}, 1u, {}, {}, {}, {}, InferMode::Async, {} },
          m_tag(tag){};
