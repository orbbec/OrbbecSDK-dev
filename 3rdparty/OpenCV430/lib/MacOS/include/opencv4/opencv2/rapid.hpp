 ...
 */
CV_EXPORTS_W void extractControlPoints(int num, int len, InputArray pts3d, InputArray rvec, InputArray tvec, InputArray K, const Size &imsize, InputArray tris,
                                       OutputArray ctl2d, OutputArray ctl3d);
/**
 ...
 */
CV_EXPORTS_W void convertCorrespondencies(InputArray cols, InputArray srcLocations, OutputArray pts2d, InputOutputArray pts3d = noArray(),
 ...
 */
CV_EXPORTS_W float rapid(InputArray img, int num, int len, InputArray pts3d, InputArray tris, InputArray K, InputOutputArray rvec, InputOutputArray tvec,
...
public:
    virtual ~Tracker();
    CV_WRAP virtual float compute(InputArray img, int num, int len, InputArray K, InputOutputArray rvec, InputOutputArray tvec,
