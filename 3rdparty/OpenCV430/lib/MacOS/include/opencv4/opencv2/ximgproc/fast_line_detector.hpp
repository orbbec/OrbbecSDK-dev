...
public:
    ...
    /** @brief Draws the line segments on a given image.
      ...
      */
    CV_WRAP virtual void drawSegments(InputOutputArray image, InputArray lines, bool draw_arrow = false, Scalar linecolor = Scalar(0, 0, 255),
...
*/
CV_EXPORTS_W Ptr<FastLineDetector> createFastLineDetector(int length_threshold = 10, float distance_threshold = 1.414213562f, double canny_th1 = 50.0,
                                                          double canny_th2 = 50.0, int canny_aperture_size = 3, bool do_merge = false);
