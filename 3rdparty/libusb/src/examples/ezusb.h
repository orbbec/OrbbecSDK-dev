...
#define FX_TYPE_NAMES \
    { "an21", "fx", "fx2", "fx2lp", "fx3" }
...
#define IMG_TYPE_NAMES \
    { "Intel HEX", "Cypress 8051 IIC", "Cypress 8051 BIX", "Cypress IMG format" }
...
#define FX_KNOWN_DEVICES                                                                                                                             \
    {                                                                                                                                                \
        { 0x0547, 0x2122, FX_TYPE_AN21, "Cypress EZ-USB (2122S)" }, { 0x0547, 0x2125, FX_TYPE_AN21, "Cypress EZ-USB (2121S/2125S)" },                \
            { 0x0547, 0x2126, FX_TYPE_AN21, "Cypress EZ-USB (2126S)" }, { 0x0547, 0x2131, FX_TYPE_AN21, "Cypress EZ-USB (2131Q/2131S/2135S)" },      \
            { 0x0547, 0x2136, FX_TYPE_AN21, "Cypress EZ-USB (2136S)" }, { 0x0547, 0x2225, FX_TYPE_AN21, "Cypress EZ-USB (2225)" },                   \
            { 0x0547, 0x2226, FX_TYPE_AN21, "Cypress EZ-USB (2226)" }, { 0x0547, 0x2235, FX_TYPE_AN21, "Cypress EZ-USB (2235)" },                    \
            { 0x0547, 0x2236, FX_TYPE_AN21, "Cypress EZ-USB (2236)" }, { 0x04b4, 0x6473, FX_TYPE_FX1, "Cypress EZ-USB FX1" },                        \
            { 0x04b4, 0x8613, FX_TYPE_FX2LP, "Cypress EZ-USB FX2LP (68013A/68014A/68015A/68016A)" }, { 0x04b4, 0x00f3, FX_TYPE_FX3, "Cypress FX3" }, \
    }
