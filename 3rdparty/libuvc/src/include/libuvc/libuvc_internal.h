...
enum uvc_int_subclass_code { UVC_SC_UNDEFINED = 0x00, UVC_SC_VIDEOCONTROL = 0x01, UVC_SC_VIDEOSTREAMING = 0x02, UVC_SC_VIDEO_INTERFACE_COLLECTION = 0x03 };
...
enum uvc_ep_desc_subtype { UVC_EP_UNDEFINED = 0x00, UVC_EP_GENERAL = 0x01, UVC_EP_ENDPOINT = 0x02, UVC_EP_INTERRUPT = 0x03 };
...
enum uvc_su_ctrl_selector { UVC_SU_CONTROL_UNDEFINED = 0x00, UVC_SU_INPUT_SELECT_CONTROL = 0x01 };
...
enum uvc_status_type { UVC_STATUS_TYPE_CONTROL = 1, UVC_STATUS_TYPE_STREAMING = 2 };
...
struct uvc_stream_handle {
    ...
    void                   *user_ptr;
    uint32_t                actual_transfer_buff_num;
    ...
    /* payload header */
    uint8_t *payload_header_outbuf, *payload_header_holdbuf;
    size_t   payload_header_got_bytes, payload_header_hold_bytes;
};
