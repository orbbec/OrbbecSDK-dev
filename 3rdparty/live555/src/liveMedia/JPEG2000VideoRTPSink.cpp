...
JPEG2000VideoRTPSink::JPEG2000VideoRTPSink(UsageEnvironment &env, Groupsock *RTPgs) : VideoRTPSink(env, RTPgs, 98, 90000, "jpeg2000") {}

JPEG2000VideoRTPSink::~JPEG2000VideoRTPSink() {}

JPEG2000VideoRTPSink *JPEG2000VideoRTPSink::createNew(UsageEnvironment &env, Groupsock *RTPgs) {
    return new JPEG2000VideoRTPSink(env, RTPgs);
}

#define JPEG2000_PAYLOAD_HEADER_SIZE 8

void JPEG2000VideoRTPSink ::doSpecialFrameHandling(unsigned fragmentationOffset, unsigned char *frameStart, unsigned numBytesInFrame,
