...
static unsigned const live_tabsel[2][3][16] = { { { 32, 32, 64, 96, 128, 160, 192, 224, 256, 288, 320, 352, 384, 416, 448, 448 },
...
void MP3FrameParams::setParamsFromHeader() {
    ...
    layer = 4 - ((hdr >> 17) & 3);
    if(layer == 4)
        layer = 3;  // layer==4 is not allowed
...
#define TRUNC_FAIRLY
static unsigned updateSideInfoSizes(MP3SideInfo &sideInfo, Boolean isMPEG2, unsigned char const *mainDataPtr, unsigned allowedNumBits, unsigned &part23Length0a,
                                    unsigned &part23Length0aTruncation, unsigned &part23Length0b, unsigned &part23Length0bTruncation, unsigned &part23Length1a,
                                    unsigned &part23Length1aTruncation, unsigned &part23Length1b, unsigned &part23Length1bTruncation) {
    ...
    updateSideInfoForHuffman(sideInfo, isMPEG2, mainDataPtr, p23L0, p23L1, part23Length0a, part23Length0aTruncation, part23Length0b, part23Length0bTruncation,
...
Boolean GetADUInfoFromMP3Frame(unsigned char const *framePtr, unsigned totFrameSize, unsigned &hdr, unsigned &frameSize, MP3SideInfo &sideInfo,
    ...
    fprintf(stderr, "mp3GetADUInfoFromFrame: hdr: %08x, frameSize: %d, part2_3_lengths: %d,%d,%d,%d, aduSize: %d, backpointer: %d\n", hdr, frameSize,
            sideInfo.ch[0].gr[0].part2_3_length, sideInfo.ch[0].gr[1].part2_3_length, sideInfo.ch[1].gr[0].part2_3_length, sideInfo.ch[1].gr[1].part2_3_length,
            aduSize, backpointer);
#endif
...
unsigned TranscodeMP3ADU(unsigned char const *fromPtr, unsigned fromSize, unsigned toBitrate, unsigned char *toPtr, unsigned toMaxSize,
    ...
    unsigned numAduBits = updateSideInfoSizes(sideInfo, outFr.isMPEG2, fromPtr, 8 * desiredOutAduSize, part23Length0a, part23Length0aTruncation, part23Length0b,
                                              part23Length0bTruncation, part23Length1a, part23Length1aTruncation, part23Length1b, part23Length1bTruncation);
#ifdef DEBUG
    fprintf(stderr, "shrinkage %d->%d [(%d,%d),(%d,%d)] (trunc: [(%d,%d),(%d,%d)]) {%d}\n", inAduSize, (numAduBits + 7) / 8, part23Length0a, part23Length0b,
            part23Length1a, part23Length1b, part23Length0aTruncation, part23Length0bTruncation, part23Length1aTruncation, part23Length1bTruncation,
            maxOutAduSize);
#endif
