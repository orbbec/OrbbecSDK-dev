...
MP3StreamState::MP3StreamState() : fFid(NULL), fPresentationTimeScale(1) {}
...
#endif
        if((fr().hdr & 0xffe00000) != 0xffe00000 || (fr().hdr & 0x00060000) == 0  // undefined 'layer' field
