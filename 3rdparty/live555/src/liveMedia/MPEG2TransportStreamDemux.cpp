...
MPEG2TransportStreamDemux *MPEG2TransportStreamDemux ::createNew(UsageEnvironment &env, FramedSource *inputSource, FramedSource::onCloseFunc *onCloseFunc,
                                                                 void *onCloseClientData) {
    return new MPEG2TransportStreamDemux(env, inputSource, onCloseFunc, onCloseClientData);
}

MPEG2TransportStreamDemux ::MPEG2TransportStreamDemux(UsageEnvironment &env, FramedSource *inputSource, FramedSource::onCloseFunc *onCloseFunc,
                                                      void *onCloseClientData)
