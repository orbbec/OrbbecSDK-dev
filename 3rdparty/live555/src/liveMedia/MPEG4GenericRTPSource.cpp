...
MPEG4GenericRTPSource *MPEG4GenericRTPSource::createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat, unsigned rtpTimestampFrequency,
                                                        char const *mediumName, char const *mode, unsigned sizeLength, unsigned indexLength,
...
MPEG4GenericRTPSource ::MPEG4GenericRTPSource(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat, unsigned rtpTimestampFrequency,
                                              char const *mediumName, char const *mode, unsigned sizeLength, unsigned indexLength, unsigned indexDeltaLength)
...
MPEG4GenericBufferedPacket ::MPEG4GenericBufferedPacket(MPEG4GenericRTPSource *ourSource) : fOurSource(ourSource) {}
...
unsigned MPEG4GenericBufferedPacket ::nextEnclosedFrameSize(unsigned char *& /*framePtr*/, unsigned dataSize) {
    ...
    if(fOurSource->fNextAUHeader >= numAUHeaders) {
        fOurSource->envir() << "MPEG4GenericBufferedPacket::nextEnclosedFrameSize(" << dataSize << "): data error (" << auHeader << ","
...
static unsigned const samplingFrequencyFromIndex[16] = { 96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350, 0, 0, 0 };
