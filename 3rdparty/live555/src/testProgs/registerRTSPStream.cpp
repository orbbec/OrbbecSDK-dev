...
int main(int argc, char const **argv) {
    ...
    if(sscanf(argv[2], "%hu", &remoteClientPortNum) != 1 || remoteClientPortNum == 0 || remoteClientPortNum == 0xFFFF)
        usage();
    ...
    RTSPRegisterSender::createNew(*env, remoteClientNameOrAddress, remoteClientPortNum, rtspURLToRegister, registerResponseHandler, ourAuthenticator,
                                  requestStreamingViaTCP, proxyURLSuffix, False /*reuseConnection*/, 1 /*verbosityLevel*/, programName);
