...
public:
    static ourRTSPClient *createNew(UsageEnvironment &env, char const *rtspURL, int verbosityLevel = 0, char const *applicationName = NULL,
...
void continueAfterPLAY(RTSPClient *rtspClient, int resultCode, char *resultString) {
    ...
    do {
        ...
        if(scs.duration > 0) {
            ...
            scs.streamTimerTask   = env.taskScheduler().scheduleDelayedTask(uSecsToDelay, (TaskFunc *)streamStopEventHandler, rtspClient);
        }
