...
public:
    static constexpr const bool value =
        is_string<T>::value || std::is_convertible<T, std_string_view<char>>::value || !std::is_void<decltype(check<T>(nullptr))>::value;
};
...
class is_tuple_formattable_<T, C, true>
{
    ...
    static decltype(check2(index_sequence<I...>{},
        integer_sequence<bool, (is_formattable<typename std::tuple_element<I, T>::type, C>::value)...>{})) check(index_sequence<I...>);
...
using range_formatter_type = conditional_t<is_formattable<Element, Char>::value,
