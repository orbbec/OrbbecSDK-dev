...
/**=======================================================================================================
 ...
 28-Sep-2020            ZYB                     add wide-string load/save function and
                                     replace _DEBUG of Macro-keyWord with NDEBUG in gcc compiler
=======================================================================================================**/
...
public:
    ...
    */
    ...
    XMLError LoadFromByteBuffer(uint8_t *buffer, uint32_t size);
