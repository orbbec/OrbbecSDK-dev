...
int main(void) try {
    ...
    config->enableVideoStream(OB_STREAM_DEPTH, 640, OB_HEIGHT_ANY, OB_FPS_ANY, OB_FORMAT_Y16);
    config->enableVideoStream(OB_STREAM_COLOR, 1280, OB_HEIGHT_ANY, OB_FPS_ANY, OB_FORMAT_RGB);
