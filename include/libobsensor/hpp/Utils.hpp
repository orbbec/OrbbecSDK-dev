...
public:
     ...
     * @return bool Transform result
     */
    OB_EXPORT bool transformation2dto2d(const OBCameraIntrinsic source_intrinsic, const OBCameraDistortion source_distortion, const OBPoint2f source_point2f,
