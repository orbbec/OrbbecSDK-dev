 ...
 */
OB_API ob_frame *ob_create_frame(ob_frame_type frame_type, ob_format format, uint32_t data_size, ob_error **error);
 ...
 */
OB_API ob_frame *ob_clone_frame(const ob_frame *ref_frame, bool copy_data, ob_error **error);
 ...
 * @return ob_frame* Return the new frame object.
 */
OB_API ob_frame *ob_create_frame_from_stream_profile( const ob_stream_profile *stream_profile, ob_error **error);
 ...
 * @return ob_frame* Return the frame object.
 */
OB_API ob_frame *ob_create_frame_from_buffer(ob_frame_type frame_type, ob_format format, uint8_t *buffer, uint32_t buffer_size,
 ...
 * @return ob_frame* Return the frame object.
 */
OB_API ob_frame *ob_create_video_frame_from_buffer(ob_frame_type frame_type, ob_format format, uint32_t width, uint32_t height, uint32_t stride_bytes,
 ...
 */
OB_API uint64_t ob_frame_get_index(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_format ob_frame_get_format(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_frame_type ob_frame_get_type(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint64_t ob_frame_get_timestamp_us(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint64_t ob_frame_get_system_timestamp_us(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint64_t ob_frame_get_global_timestamp_us(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API const uint8_t *ob_frame_get_data(const ob_frame *frame, ob_error **error);
 ...
 * @param[out] error Log error messages
 */
OB_API void ob_frame_update_data(ob_frame *frame, const uint8_t *data, uint32_t data_size, ob_error **error);
 ...
 */
OB_API uint32_t ob_frame_get_data_size(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API const uint8_t *ob_frame_get_metadata(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint32_t ob_frame_metadata_size(const ob_frame *frame, ob_error **error);
 ...
 * @param[out] error Log error messages
 */
OB_API void ob_frame_update_metadata(ob_frame *frame, const uint8_t *metadata, size_t metadata_size, ob_error **error);
 ...
 * @param[out] error Log error messages
 */
OB_API bool ob_frame_has_metadata(const ob_frame *frame, ob_frame_metadata_type type, ob_error **error);
 ...
 */
OB_API int64_t ob_frame_get_metadata_value(const ob_frame *frame, ob_frame_metadata_type type, ob_error **error);
 ...
 */
OB_API ob_stream_profile *ob_frame_get_stream_profile(const ob_frame *frame, ob_error **error);
 ...
 * @param error Log error messages.
 */
OB_API void ob_frame_set_stream_profile(ob_frame *frame, const ob_stream_profile *stream_profile, ob_error **error);
 ...
 */
OB_API ob_sensor *ob_frame_get_sensor(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_device *ob_frame_get_device(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint32_t ob_video_frame_get_width(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint32_t ob_video_frame_get_height(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint8_t ob_video_frame_pixel_available_bit_size(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_sensor_type ob_ir_frame_get_source_sensor_type(const ob_frame *frame, ob_error **ob_error);
 ...
 */
OB_API float ob_depth_frame_get_value_scale(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API float ob_points_frame_get_coordinate_value_scale(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_accel_value ob_accel_frame_get_value(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API float ob_accel_frame_get_temperature(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API ob_gyro_value ob_gyro_frame_get_value(const ob_frame *frame, ob_error **error);
 ...
 * @return float Return the temperature value.
 */
OB_API float ob_gyro_frame_get_temperature(const ob_frame *frame, ob_error **error);
 ...
 */
OB_API uint32_t ob_frameset_get_frame_count(const ob_frame *frameset, ob_error **error);
