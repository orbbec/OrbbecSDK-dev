...
Astra2AlgParamManager::Astra2AlgParamManager(IDevice *owner) : DisparityAlgParamManagerBase(owner) {
    fetchParamFromDevice();
    registerBasicExtrinsics();
}

void Astra2AlgParamManager::fetchParamFromDevice() {
    try {
        auto owner                   = getOwner();
...
void Astra2AlgParamManager::registerBasicExtrinsics() {
