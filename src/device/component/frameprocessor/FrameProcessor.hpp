...
public:
    ...
    void setHardwareD2CProcessParams(uint32_t colorWidth,uint32_t colorHeight,uint32_t depthWidth,uint32_t depthHeight,std::vector<OBCameraParam> calibrationCameraParams,std::vector<OBD2CProfile> d2cProfiles);
