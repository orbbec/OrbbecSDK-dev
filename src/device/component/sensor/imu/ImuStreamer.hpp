...
public:
    ...
    void start(std::shared_ptr<const StreamProfile> sp, FrameCallbackUnsafe callback);
...
private:
    ...
    std::mutex                                                          cbMtx_;
    std::map<std::shared_ptr<const StreamProfile>, FrameCallbackUnsafe> callbacks_;
