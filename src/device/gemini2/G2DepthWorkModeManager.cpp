...
const OBDepthWorkMode_Internal &G2DepthWorkModeManager::getCurrentDepthWorkMode() const {
...
void G2DepthWorkModeManager::switchDepthWorkMode(const OBDepthWorkMode_Internal &targetDepthMode) {
    auto owner = getOwner();
    {
