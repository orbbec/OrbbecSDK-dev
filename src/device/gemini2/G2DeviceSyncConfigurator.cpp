...
G2DeviceSyncConfigurator::G2DeviceSyncConfigurator(IDevice *owner, const std::vector<OBMultiDeviceSyncMode> &supportedSyncModes)
    : DeviceComponentBase(owner), supportedSyncModes_(supportedSyncModes), isSyncConfigInit_(false) {}

OBMultiDeviceSyncConfig G2DeviceSyncConfigurator::getSyncConfig() {
...
void G2DeviceSyncConfigurator::setSyncConfig(const OBMultiDeviceSyncConfig &deviceSyncConfig) {
...
uint16_t G2DeviceSyncConfigurator::getSupportedSyncModeBitmap() {
...
void G2DeviceSyncConfigurator::triggerCapture() {
    auto owner          = getOwner();
    auto propertyServer = owner->getPropertyServer();
    propertyServer->setPropertyValueT(OB_PROP_CAPTURE_IMAGE_SIGNAL_BOOL, true);
}

void G2DeviceSyncConfigurator::setTimestampResetConfig(const OBDeviceTimestampResetConfig &timestampResetConfig) {
...
OBDeviceTimestampResetConfig G2DeviceSyncConfigurator::getTimestampResetConfig() {
...
void G2DeviceSyncConfigurator::timestampReset() {
    auto owner          = getOwner();
    auto propertyServer = owner->getPropertyServer();
    propertyServer->setPropertyValueT(OB_PROP_TIMER_RESET_ENABLE_BOOL, true);
}

void G2DeviceSyncConfigurator::timerSyncWithHost() {
