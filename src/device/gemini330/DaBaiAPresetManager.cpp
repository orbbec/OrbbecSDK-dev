...
const std::string &DaBaiAPresetManager::getCurrentPresetName() const {
...
void DaBaiAPresetManager::loadPresetFromJsonData(const std::string &presetName, const std::vector<uint8_t> &jsonData) {
    Json::Value  root;
    Json::Reader reader;
...
void DaBaiAPresetManager::loadPresetFromJsonFile(const std::string &filePath) {
    Json::Value   root;
...
Json::Value DaBaiAPresetManager::exportSettingsAsPresetJsonValue(const std::string &presetName) {
...
void DaBaiAPresetManager::exportSettingsAsPresetJsonFile(const std::string &filePath) {
...
void DaBaiAPresetManager::loadCustomPreset(const std::string &presetName, const DaBaiAPreset &preset) {
