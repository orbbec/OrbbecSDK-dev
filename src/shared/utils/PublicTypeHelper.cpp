...
std::map<OBFrameMetadataType, std::string> Metadata_Str_Map = { { OB_FRAME_METADATA_TYPE_TIMESTAMP, "Timestamp" },
                                                                ...
                                                                { OB_FRAME_METADATA_TYPE_HDR_SEQUENCE_NAME, "Sequence Name" },
                                                                { OB_FRAME_METADATA_TYPE_HDR_SEQUENCE_SIZE, "Sequence Size" },
                                                                { OB_FRAME_METADATA_TYPE_HDR_SEQUENCE_INDEX, "Sequence Index" },
